👉 I've also built Phoenix [Kickstart Pro](https://github.com/rafaltrojanowski/kickstart_pro) which is a version of Kickstart that includes payments with Stripe, Subscriptions, Pricing Plans, and much more.
